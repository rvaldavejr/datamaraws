...
\begin{adjustwidth}{30pt}{0pt}
    ...
    The final deployment phase outlines the integration of the trained model into the web-based visualization module. It details the user journey from website access to searching the interactive heatmap and finally downloading segmented regional information.    
\end{adjustwidth}
