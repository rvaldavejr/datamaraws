...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|
        ...
        \textbf{Alternative Data (OSM)} & 
        \textbf{Temporal / Time-Series Analysis} & 
        \textbf{Used in the Philippines} \\ \hline
        ...
        % Row 4
        \textcite{Jimenez2025} & 
        Generalized Least Squares, Support Vector regression, Neural Network and Random Forest & 
        Yes & Yes & No & Yes \\ \hline
        
        % Row 5
        \textcite{SrishtiGulecha2024} & 
        Decision Tree Regressor, Random Forest Regressor, CNN, MLP & 
        Yes & Yes & No & No \\ \hline
