...
\begin{center}
 ...
 Satellite Imagery and CNN–LSTM Architectures”} prepared and submitted by:
    ...
    \begin{tabular}{cc}
        ...
        \textbf{MS. ELISA V. MALASAGA} & \hspace{1cm} \textbf{DR. GONZALES} \\
...
This study focuses on the development of a spatiotemporal deep learning system designed to estimate poverty levels across the entire Philippine archipelago. While the model training is grounded in ground-truth socioeconomic data from the 2022 Demographic and Health Survey (DHS), utilizing all available DHS survey clusters nationwide to maximize the poverty gradient represented in the training data. The generation of poverty maps and SHAP-based analytics reports, however, is scoped to eleven local governmental units: the five provinces with the highest poverty incidence, the five provinces with the lowest poverty incidence as shown in table \ref{tab:10-selected-provinces}, and the National Capital Region. This deliberate contrast between the poorest and wealthiest provinces maximizes the analytical value of the model, enabling direct comparison of the spatial and infrastructural drivers of poverty across opposite ends of the socioeconomic spectrum.
...
\begin{table}[htbp]
    ...
    \caption[Poverty incidence among families by province]{Poverty incidence among families by province \parencite{PSA2023b}}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|
        ...
        CNN &LSTM & 
        Yes & Yes & Phlippines (trained nationwide; outputs for select localities) \\ \hline
...
\begin{adjustwidth}{30pt}{0pt}
    ...
    Proceeding this, the system extracts features from both daytime and nighttime data to train and then validate the hybrid CNN-LSTM architecture. This stage concludes the generation of the poverty mapping output.
